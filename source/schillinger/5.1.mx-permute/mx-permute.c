...
void findPermutations(t_atom_long *arr, t_atom_long index, t_atom_long n,
                      t_atom_long **result, int *r_index);
...
void ext_main(void *r)
{
    ...
    c = class_new("mx-permute", (method)mx_permute_new, (method)mx_permute_free,
                  sizeof(t_mx_permute), NULL, A_GIMME, 0);
    ...
    class_addmethod(c, (method)mx_permute_anticircular, "anticircular", A_LONG,
                    0);
...
void mx_permute_pat(t_mx_permute *x, t_symbol *s, long argc, t_atom *argv)
{
    ...
    */
    ...
    x->permutations =
        (t_atom_long **)sysmem_newptrclear(x->unq_perm * sizeof(t_atom_long *));
