...
void outlet_s(t_mxp2_nsg *x, char *selector, int argc, char *msg, ...);
...
void ext_main(void *r){
    ...
    c = class_new("mxp2", (method)mxp2_nsg_new, (method)mxp2_nsg_free, sizeof(t_mxp2_nsg), NULL, A_GIMME, 0);
