...
void mx_e_perform64(t_mx_e *x, t_object *dsp64, double **ins, long numins,
                    double **outs, long numouts, long sampleframes, long flags,
                    void *userparam);
void mx_e_dsp64(t_mx_e *x, t_object *dsp64, short *count, double samplerate,
...
void ext_main(void *r)
{
    ...
    c = class_new("mx-e~", (method)mx_e_new, (method)mx_e_free, sizeof(t_mx_e),
                  NULL, A_GIMME, 0);
    ...
    class_addmethod(c, (method)mx_e_multichanneloutputs, "multichanneloutputs",
                    A_CANT, 0);
